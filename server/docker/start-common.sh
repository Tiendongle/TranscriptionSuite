...
if [[ "$MODE" == "remote" ]]; then
    ...
    cert_path_hint="$HOME/.config/Tailscale/my-machine.crt"
    key_path_hint="$HOME/.config/Tailscale/my-machine.key"
    ...
    if [[ "$REMOTE_TLS_PROFILE" == "lan" ]]; then
        ...
        cert_path_hint="$HOME/.config/TranscriptionSuite/lan-server.crt"
        key_path_hint="$HOME/.config/TranscriptionSuite/lan-server.key"
...
if [[ "$MODE" == "remote" ]]; then
    ...
    echo "=========================================================="
    echo ""
    echo "  HTTPS URL:   https://localhost:${SERVER_PORT:-9786}"
    echo "  Web UI:      https://localhost:${SERVER_PORT:-9786}/record"
    echo "  Notebook:    https://localhost:${SERVER_PORT:-9786}/notebook"
    echo ""
    ...
    echo "=========================================================="
    echo ""
    echo "  Server URL:  http://localhost:${SERVER_PORT:-9786}"
    echo "  Web UI:      http://localhost:${SERVER_PORT:-9786}/record"
    echo "  Notebook:    http://localhost:${SERVER_PORT:-9786}/notebook"
fi
